...
const residence = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".residence__slider", {
  slidesPerView: 3,
  spaceBetween: 20,
  loop: true,
  autoplay: {
...
const choose = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".choose__slider", {
  slidesPerView: 1,
  loop: true,
  autoplay: {
    delay: 200
